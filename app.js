...
import apiUploads from "./api/routes/upload.route.js";
import apiFacesRouters from "./api/routes/face.route.js";
...
app.use("/api/upload", apiUploads);
app.use("/api/face", apiFacesRouters);
